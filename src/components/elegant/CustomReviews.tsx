...
export default function CustomReviews({
  reviewsTitle = "Loved by modern founders",
  reviewsSubtitle = "Real customers, real results. Credibility that compounds—design that earns trust."
}: CustomReviewsProps) {
  return (
    <div>
      <header className="text-center mb-8 md:mb-12">
        <h2 className="text-3xl md:text-4xl font-semibold">{reviewsTitle}</h2>
