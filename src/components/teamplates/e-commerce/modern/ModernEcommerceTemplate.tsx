...
export default function ModernEcommerceTemplate() {
  return (
    <div className={cn(poppins.variable, GeistMono.variable, "modern-ecommerce-template font-sans antialiased")}>
      <style jsx global>{`
        .modern-ecommerce-template {
          ...
          --primary-foreground: oklch(0.15 0.02 60); /* dark text on light orange variants */
        ...
        .modern-ecommerce-template.dark {
        ...
        .modern-ecommerce-template *:focus-visible {
